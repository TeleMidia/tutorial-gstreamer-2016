...
\item O elemento ``filesrc'' lê um arquivo Ogg do disco e escreve o fluxo de
  bytes resultante na sua \en{source pad}.  Ogg é~\cite{ogg-rfc-3533} um
...
filtro genérico que lê uma amostra da sua \en{sink pad}, imprime o seu
tamanho na saída padrão e repassa-a à sua \en{source pad}.  Já o elemento
