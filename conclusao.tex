...
vídeos e/ou áudios em um mesmo \en{pipeline}.  Elementos do tipo \en{mix}
...
\en{framework} GObject também serão bem úteis.  Mais ainda, caso C não seja a
sua linguagem favorita, existem também vários~\en{bindings} do GStreamer para
outras
