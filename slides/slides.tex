...
\end{lstlisting}
  ...
  \begin{adjustbox}{max totalsize={.8\textwidth}{\textheight},center}
    \begin{tikzpicture}
      ...
      \node (audiomixer) [element, right of=audioconvert1] at ($(audioconvert1)!0.5!(audioconvert2)$) {audiomixer} ;
      \node (audioconvert3) [element, right of=audiomixer] {audioconvert};
      ...
      \draw [->, arrow] (audioconvert1) -- (audiomixer);
      \draw [->, arrow] (audioconvert2) -- (audiomixer);
      \draw [->, arrow] (audiomixer) -- (audioconvert3);
