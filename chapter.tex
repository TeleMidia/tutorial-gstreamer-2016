...
processadores de áudio que permite modificar o ganho dos graves, médios e
...
amostras no formato esperado.  Há cinco possíveis combinações de filtros:
\begin{itemize}
...
\C{main} apesar de omitido é trivial.  Ela cria um elemento
