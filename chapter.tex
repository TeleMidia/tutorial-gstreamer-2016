...
versão simplificada da Figura~\ref{fig:pipe-ogg}.  A diferença nesse caso
está nos elementos adicionais ``audioconvert'', que aparece entre o
``vorbisdec'' e o ``alsasink'', e ``queue'', que aparece entre o
``oggdemux'' e o ``theoradec''.
