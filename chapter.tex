...
interessante para multimídia porque aproxima %%
%%
...
modelo de \en{dataflow} induz implementações flexíveis e eficientes já que ele
...
Ogg~\cite{ogg-rfc-3533}.  Ogg~\cite{ogg-rfc-3533} é um formato para
multiplexação de fluxos de áudio, vídeo e texto.  Os nós da figura representam
...
Se os \rghl{elementos fluxo}{?} acima operarem abaixo da taxa de consumo dos
...
inverso.  Se os \rghl{elementos fluxo}{?} acima operarem muito acima da taxa de
