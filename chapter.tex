...
anteriores ao \en{sinks} operarem rápido o bastante, os \en{buffers} dos
\en{sinks} nunca ficarão vazios e todas as amostras serão exibidas no
momento correto.

No entanto, caso os elementos fluxo acima operem abaixo da taxa de
reprodução pode ser que o \en{buffer} de um dos \en{sinks} esvazie; ou seja,
pode ser que chegue o momento de exibir uma amostra e o \en{sink}
simplesmente não tenha o que exibir.  Nesse caso,
...
%  LocalWords:  demultiplexa-o demultiplexador
