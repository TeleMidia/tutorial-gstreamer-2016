...
\en{thread} da aplicação sobre acontecimentos no \en{pipeline}, por exemplo,
mudança de estado de elementos, fim do fluxo, erros, \en{warnings}, etc., e
permitem que aplicação reaja da maneira apropriada.
...
postada no barramento.  A função \C{gst_bus_timed_pop_filtered} recebe o
\en{bus}, um tempo máximo de espera, e uma máscara de tipo de mensagens, e
bloqueia até que o tempo máximo seja atingido ou até que uma mensagem de um
dos tipos esperados seja postada no \en{bus}.
