...
O pacote \en{gstreamer}, além do \en{gst-launch}, também instala o programa
\en{gst-inspect}, que permite inspecionar os \en{plugins} e elementos
disponíveis numa instalação GStreamer.\footnote{Em algumas instalações o
  nome do comando é \en{gst-inspect-1.0}.}
